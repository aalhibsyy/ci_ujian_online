...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Jan 2020 pada 17.29
...
--
-- Dumping data untuk tabel `detail_evaluasi`
--

INSERT INTO `detail_evaluasi` (`id_detail_evaluasi`, `evaluasi_kd`, `penilaian_id`, `nilai`) VALUES
(29, 1, 2, 'SP'),
(30, 2, 1, 'SP'),
(31, 2, 3, 'P'),
(32, 2, 4, 'P'),
...
INSERT INTO `evaluasi` (`kd_evaluasi`, `materi_id`, `siswa_id`, `kritik_saran`, `inspirasi`, `perbedaan`, `tanggal`) VALUES
(1, 2, 2, 'bagus', 'kecerdasan', NULL, '2020-01-29 06:06:53'),
(2, 1, 1, 'edan', 'imajinasi', NULL, '2020-01-29 09:31:20'),
(3, 2, 3, 'edun', 'cincay', 'bedalah', '2020-01-29 11:53:51');
...
(28, '::1', 'admin', 1580312639),
(29, '::1', 'admin', 1580312644),
(30, '::1', 'admin', 1580312675);
...
(3, 'siswa3', '16171819', 'siswa3@gmail.com', 'P', 2),
(4, 'jauhar', '124567', 'jauhar1@gmail.com', 'L', 3);
...
(1, '127.0.0.1', 'Administrator', '$2y$12$tGY.AtcyXrh7WmccdbT1rOuKEcTsKH6sIUmDr0ore1yN4LnKTTtuu', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1580314759, 1, 'Manager Training', 'Non Railways', 'ADMIN', '0'),
(14, '::1', '12121212', '$2y$10$PAD59dMENTj1iojMEcBayeldZ6xGOACW.z5s393js/lyWmcO.5/gG', 'pengajar@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1579860635, 1580290124, 1, 'pengajar', 'pengajar', NULL, NULL),
(20, '::1', '11111111', '$2y$10$9q3D7OZdu3CHTzkim9UzwOhWi8FXvGz7qRAQNel/u5X9Fih2k6vz6', 'siswa2@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1580066726, 1580314725, 1, 'siswa2', 'siswa2', NULL, NULL),
(21, '::1', '12345678', '$2y$10$/kNXWFw4JiKnYs5nx.g9L.d6euvyrg0.XOUHnkrfTx50/hULWckhC', 'siswa@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1580290204, 1580290229, 1, 'siswa', 'siswa', NULL, NULL),
(22, '::1', '16171819', '$2y$10$iZ/wBcTAp8YJB6VyyudYle5MMde3Cyavi7RTNPUAZB84rpHZ7TE2S', 'siswa3@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1580298668, 1580298682, 1, 'siswa3', 'siswa3', NULL, NULL),
(23, '::1', '124567', '$2y$10$J9BLGF1uUyUtWKAVrhif.u0P.wgI6/iWUUzfq48AezuXhWm.LNLsu', 'jauhar1@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1580314871, 1580315015, 1, 'jauhar', 'jauhar', NULL, NULL);
...
--
ALTER TABLE `detail_evaluasi`
  MODIFY `id_detail_evaluasi` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `materi`
  MODIFY `id_materi` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `penilaian`
  MODIFY `id_penilaian` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

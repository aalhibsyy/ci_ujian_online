...
--
DELIMITER $$
CREATE TRIGGER `edit_user_pengajar` BEFORE UPDATE ON `pengajar` FOR EACH ROW UPDATE `users` SET `email` = NEW.email, `username` = NEW.nip WHERE `users`.`username` = OLD.nip
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `hapus_user_pengajar` BEFORE DELETE ON `pengajar` FOR EACH ROW DELETE FROM `users` WHERE `users`.`username` = OLD.nip
$$
DELIMITER ;
...
--
-- Table structure for table `jurusan_diklat`
--

CREATE TABLE `jurusan_diklat` (
  `id` int(11) NOT NULL,
  `diklat_id` int(11) NOT NULL,
...
--
-- Dumping data for table `jurusan_diklat`
--

INSERT INTO `jurusan_diklat` (`id`, `diklat_id`, `jurusan_id`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 2, 2),
(6, 5, 2);
...
INSERT INTO `kelas_pengajar` (`id`, `kelas_id`, `pengajar_id`) VALUES
(1, 3, 1),
(2, 2, 1),
(3, 1, 1),
(9, 2, 3),
...
--
-- Indexes for table `jurusan_diklat`
--
ALTER TABLE `jurusan_diklat`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `jurusan_diklat`
--
ALTER TABLE `jurusan_diklat`
...
--
ALTER TABLE `pengajar`
  ADD CONSTRAINT `pengajar_ibfk_1` FOREIGN KEY (`diklat_id`) REFERENCES `diklat` (`id_diklat`);
...
--
-- Constraints for table `jurusan_diklat`
--
ALTER TABLE `jurusan_diklat`
  ADD CONSTRAINT `jurusan_diklat_ibfk_1` FOREIGN KEY (`jurusan_id`) REFERENCES `jurusan` (`id_jurusan`),
  ADD CONSTRAINT `jurusan_diklat_ibfk_2` FOREIGN KEY (`diklat_id`) REFERENCES `diklat` (`id_diklat`);

--
-- Constraints for table `kelas_pengajar`
--
ALTER TABLE `kelas_pengajar`
  ADD CONSTRAINT `kelas_pengajar_ibfk_1` FOREIGN KEY (`pengajar_id`) REFERENCES `pengajar` (`id_pengajar`),
  ADD CONSTRAINT `kelas_pengajar_ibfk_2` FOREIGN KEY (`kelas_id`) REFERENCES `kelas` (`id_kelas`);
...
--
ALTER TABLE `m_ujian`
  ADD CONSTRAINT `m_ujian_ibfk_1` FOREIGN KEY (`pengajar_id`) REFERENCES `pengajar` (`id_pengajar`),
  ADD CONSTRAINT `m_ujian_ibfk_2` FOREIGN KEY (`diklat_id`) REFERENCES `diklat` (`id_diklat`);

--
-- Constraints for table `tb_soal`
--
ALTER TABLE `tb_soal`
  ADD CONSTRAINT `tb_soal_ibfk_1` FOREIGN KEY (`diklat_id`) REFERENCES `diklat` (`id_diklat`),
  ADD CONSTRAINT `tb_soal_ibfk_2` FOREIGN KEY (`pengajar_id`) REFERENCES `pengajar` (`id_pengajar`);

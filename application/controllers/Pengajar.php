...
class Pengajar extends CI_Controller
{
	...
	public function save()
	{
		...
		$this->form_validation->set_rules('nip', 'NIP', 'required' . $u_nip);
		$this->form_validation->set_rules('nama_pengajar', 'Nama Pengajar', 'required|trim');

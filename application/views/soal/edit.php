                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <label for="pengajar_id" class="control-label">Pengajar (Diklat)</label>
                                ...
                                <select required="required" name="pengajar_id" id="pengajar_id" class="select2 form-group" style="width:100% !important">
                                    ...
                                    <?php 
                                    $sdm = $soal->pengajar_id.':'.$soal->diklat_id;
                                    foreach ($pengajar as $d) : 
                                        $dm = $d->id_pengajar.':'.$d->diklat_id;?>
                                        <option <?=$sdm===$dm?"selected":"";?> value="<?=$dm?>"><?=$d->nama_pengajar?> (<?=$d->nama_diklat?>)</option>
                                    <?php endforeach; ?>
                                </select>
                                ...
                                <input type="hidden" name="diklat_id" value="<?=$pengajar->diklat_id;?>">
                                <input type="text" readonly="readonly" class="form-control" value="<?=$pengajar->nama_pengajar; ?> (<?=$pengajar->nama_diklat; ?>)">
                                <?php endif; ?>
                            </div>

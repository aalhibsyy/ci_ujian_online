        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="alert bg-purple">
                    <h4>Diklat <i class="fa fa-book pull-right"></i></h4>
            ...
            <div class="col-sm-4">
                <?=form_open('ujian/save', array('id'=>'formujian'), array('method'=>'add','pengajar_id'=>$pengajar->id_pengajar, 'diklat_id'=>$diklat->diklat_id))?>

<div class="box">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            <a href="<?=base_url()?>jurusandiklat" class="btn btn-warning btn-flat btn-sm">
    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-sm-4">
                <?=form_open('jurusandiklat/save', array('id'=>'jurusandiklat'), array('method'=>'add'))?>
                <div class="form-group">
                    <label>Mata Kuliah</label>
                    <select name="diklat_id" class="form-control select2" style="width: 100%!important">
...
<script src="<?=base_url()?>assets/dist/js/app/relasi/jurusandiklat/add.js"></script>
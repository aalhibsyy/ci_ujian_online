    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                <?=form_open('kelaspengajar/save', array('id'=>'kelaspengajar'), array('method'=>'edit', 'pengajar_id'=>$id_pengajar))?>
...
<script src="<?=base_url()?>assets/dist/js/app/relasi/kelaspengajar/edit.js"></script>
<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="text-center">
            <a href="<?= base_url('uploads/import/format/penilaian.xlsx') ?>" class="btn-default btn">Download Format</a>
        </div>
        <br>
        <div class="row">
            <?= form_open_multipart('penilaian/preview'); ?>
            ...
            <div class="col-sm-6 col-sm-offset-3">
                <?php if (isset($_POST['preview'])) : ?>
                    ...
                    <?php if ($status) : ?>
                        ...
                        <?= form_open('penilaian/do_import', null, ['data' => json_encode($import)]); ?>

<div class="box">
	...
	<div class="box-body">
		<div class="mt-2 mb-3">
			...
			<a href="<?= base_url('diklat/import') ?>" class="btn btn-sm btn-flat btn-success"><i class="fa fa-upload"></i> Import</a>
...
<div class="modal fade" id="myModal">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<?= form_open('diklat/add', array('id', 'tambah')); ?>
...
<script src="<?= base_url() ?>assets/dist/js/app/master/diklat/data.js"></script>
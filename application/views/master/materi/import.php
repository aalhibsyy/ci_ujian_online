<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="text-center">
            <a href="<?= base_url('uploads/import/format/materi.xlsx') ?>" class="btn-default btn">Download Format</a>
        </div>
        <br>
        <div class="row">
            <?= form_open_multipart('materi/preview'); ?>
            ...
            <div class="col-sm-6 col-sm-offset-3">
                <?php if (isset($_POST['preview'])) : ?>
                    ...
                    <?php if ($status) : ?>
                        ...
                        <?= form_open('materi/do_import', null, ['data' => json_encode($import)]); ?>
